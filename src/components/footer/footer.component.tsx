            ...
            <div id="footer-bottom" className="flex gap-7 justify-center items-center lg:flex-col">
              <div className="flex flex-col justify-center items-start lg:items-center">
                <div className="footer-mail">
                  <a href="mailto:utkarshpatrikar@gmail.com">
                    <em>
                      <span style={{ fontStyle: "normal" }}>utkarshpatrikar@gmail.com</span>
                    </em>
                  </a>
                </div>
                <div className="footer-address text-zinc-500 font-semibold text-base">
                  <address>
                    <p className="lg:text-center">Kamthee road, Nagpur-440026</p>
                    <p className="lg:text-center">Maharashtra, India</p>
                  </address>
                </div>
                <div className="footer-link mt-3 mb-6">
                  <p className="w-full">Copyright &#169; 2025-2026</p>
                </div>
              </div>
              <div id="footerSocials" className="grid grid-cols-2 gap-5">
                <SocialLink
                  href="https://www.linkedin.com/in/utkarsh-patrikar/"
                  content="LinkedIn"
                  icon={<BsLinkedin />}
                />
                <SocialLink
                  href="https://github.com/utkarsh232005"
                  content="GitHub"
                  icon={<BsGithub />}
                />
                <SocialLink
                  href="https://www.instagram.com/_.uttkarshhh_/?__pwa=1"
                  content="Instagram"
                  icon={<BsInstagram />}
                />
                <SocialLink
                  href="https://x.com/Utkarsh_2301"
                  content="X"
                  icon={<BsTwitter />}
                />
              </div>
